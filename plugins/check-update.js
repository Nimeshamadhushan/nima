...
nima({
  ...
  try {
    ...
    // Remote version data
    const repoRawURL = 'https://raw.githubusercontent.com/Nimeshamadhushan/nima/data/version.json';
...
📎 *Repo:* https://github.com/Nimeshamadhushan/nima
👑 *Owner:* https://github.com/Nimeshamadhushan

${updateStatus}
`.trim();

    await conn.sendMessage(from, {
      image: { url: 'https://chat.whatsapp.com/HLBP338VvUC0ms5NqCkSSO?mode=ac_t' },
      caption,
      contextInfo: {

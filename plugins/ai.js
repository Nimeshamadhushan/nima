...
nima({
    ...
    try {
        ...
        if (!q) return reply("⚠️ Please provide a query for nima Ai.\n\nExample:\n.nima What is AI?");
        ...
        if (!response || !response.data || !response.data.result) {
            return reply("❌ No response received from the nima API. Please try again later.");
        }
        ...
        // Image AI à envoyer
        const ALIVE_IMG = 'https://i.postimg.cc/029xmZVt/IMG-20250801-003906-211.jpg'; // Remplacez par l'URL de votre image AI

        // Légende avec des informations formatées
        const formattedInfo = `🤖 *nima's Response:*\n\n${gptResponse}`;
...
nima({
    ...
    try {
        ...
        // AI image to attach
        const AI_IMG = 'https://i.postimg.cc/029xmZVt/IMG-20250801-003906-211.jpg'; // Replace with a valid image URL

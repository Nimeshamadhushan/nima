...
try{
const msr = (await fetchJson('https://raw.githubusercontent.com/Nimeshamadhushan/nima-DATA/refs/heads/main/MSG/mreply.json')).replyMsg

if (!isGroup) return reply(msr.only_gp)osoo
